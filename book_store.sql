...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2017 at 07:06 AM
...
CREATE TABLE `book` (
  ...
  `b_qty` int(4) NOT NULL DEFAULT '0',
...
INSERT INTO `shipping_details` (`id`, `name`, `address`, `postal_code`, `city`, `state`, `phone`, `f_id`, `isbn_num`, `book_name`, `book_price`, `book_qty`) VALUES
(16, 'nitin', ' asdads', 285123, 'Jalaun', 'Uttar Pradesh', 7275771294, 'nitin', 1548, 'nitk', 5000, 50),
(17, 'yogendra', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 5000, 50),
(18, 'erresr', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 0, 12),
(19, 'djadal', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 5000, 12),
(20, 'djadala', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 60000, 12),
(21, 'djadala', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 60000, 12),
(22, 'ad', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 60000, 12),
(23, 'ad', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 60000, 12),
(24, 'yogendra', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 5000, 1),
(25, 'ahds', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 5000, 1),
(26, 'yogendra', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 5000, 1),
(27, 'yogendra', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 1548, 'nitk', 55000, 11),
(28, 'nitin', 'NITK hotels', 575025, 'Surathkal', 'Karnataka', 8904410158, 'nitin', 123456789, 'yogendra', 400, 2),
(29, 'yogendra', 'NITK hotels', 0, 'uhuihu', 'ugg', 0, 'nitin', 123456789, 'yogendra', 600, 3);
...
(8, 'nitin kumar', 'nitin', 'nitin', 'Male', 'yogendrautgerkar@gmail.com', '9807789657', 'Ahmedabad'),
(7, 'yogendra kumar', 'yogendra', '1234', 'Male', 'yogendrautgerkar@gmail.com', '9807789657', 'Ahmedabad');
...
--
ALTER TABLE `book`
  MODIFY `b_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
...
--
ALTER TABLE `subcat`
  MODIFY `subcat_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
