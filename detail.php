<?php session_start();
	...
	$_SESSION['ISBN_VALUE']=$row['b_isbn'];
?>
						...
						<!-- start content -->
							<div id="content">
								<div class="post">
									...
									<div class="entry">
										<?php
											$original_quantity = $row['b_qty'];
											
											if($original_quantity==0){
												$original_quantity = "<b>Out Of Stock</b>";
											}
													...
													<td width="50%" height="100%">
														<table border="0"  width="100%" height="100%">
															...
															<tr>
																...
																<td align="left">'.$original_quantity.'</td>
															</tr>
														</table>
											...
											<table border="0" width="100%">
												 ...
												 //$_GET['cat']='book';
												 if ($original_quantity==0) {
												 	echo '<td><img src="images/addcart.jpg"><br><h4>Out of Stock</h4></a></td>';
												 }
